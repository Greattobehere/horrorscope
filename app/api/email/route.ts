    ...
    await resend.emails.send({
      ...
      html: `
        <div style="background:#0B0B14;color:#F2EEF7;padding:40px;font-family:serif;max-width:600px;margin:0 auto;border:2px solid #E3B84B;border-radius:12px;">
          ...
          <p style="color:#D4C5F9;font-size:18px;margin-bottom:24px;">Moira has noted your arrival.</p>
          ...
          <p style="color:#E3B84B;font-size:14px;">— Moira, Fortune Teller of Dubious Reputation</p>
        </div>
      `,
    });
