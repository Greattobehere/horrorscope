...
export async function POST(request: Request) {
  try {
    ...
    const userMessage = `The seeker is a ${sign}. Their omen score is ${omenScore} out of 100. Deliver their fate reading, Sireal.`;
