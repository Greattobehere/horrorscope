    ...
    <div className="min-h-screen bg-[#0B0B14] text-[#F2EEF7] px-6 md:px-16 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#D4C5F9] leading-relaxed">
          <p>
            HorrorScope ("we," "us") is a horror-comedy entertainment site at horrorscope.art. This page explains
            what we collect, why, and how to get it removed. It is written in plain language rather than legal
            boilerplate — if you have questions, email{" "}
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Birth date</strong> you enter to get a reading. It's sent to Anthropic's API to generate your
                personalized text and is not stored in any database of ours.
              </li>
              <li>
              ...
              <li>
                ...
                an expiry date, cryptographically signed so it can't be forged, and it stops working after the pass
                expires (November 15, 2026) or if you clear your cookies.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              transactional emails like your unlock link or newsletter). We don't sell data, and we don't share it
              with anyone else.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              There's no account system, so there's very little to delete. Clearing your cookies removes your pass
              token from your device. To unsubscribe from emails, use the link in any email we send, or contact us
              directly and we'll remove your address from our mailing list.
            </p>
          </section>
